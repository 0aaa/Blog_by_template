                ...
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="<?=self::RES?>/img/program/1.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="<?=self::RES?>/img/program/2.png" alt="">
                                </div>
                                <div class="program__content">
                                    <span>Agriculture</span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="<?=self::RES?>/img/program/3.png" alt="">
                                </div>
                                <div class="program__content">
                                    <span>Agriculture</span>
            ...
            <div class="row">
                    ...
                    <div class="single__news">
                        <div class="thumb">
                            <a href="single-blog.html">
                                <img src="<?=self::RES?>/img/news/1.png" alt="">
                            </a>
                ...
                <div class="col-md-6">
                    <div class="single__news">
                        <div class="thumb">
                            <a href="single-blog.html">
                                <img src="<?=self::RES?>/img/news/2.png" alt="">
                            </a>
